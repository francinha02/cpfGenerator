...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CPFMaker; });
...
var CPFMaker = /*#__PURE__*/function () {
  function CPFMaker() {
    _classCallCheck(this, CPFMaker);
  }

  _createClass(CPFMaker, [{
    key: "rand",
    value: function rand() {
    ...
    value: function newCpf() {
      var cleanCpf = this.rand();
      var digit1 = _CPFValidator__WEBPACK_IMPORTED_MODULE_0__["default"].generatesDigit(cleanCpf);
      var digit2 = _CPFValidator__WEBPACK_IMPORTED_MODULE_0__["default"].generatesDigit(cleanCpf + digit1);
      var cpf = cleanCpf + digit1 + digit2;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CPFValidator; });
...
var CPFValidator = /*#__PURE__*/function () {
  function CPFValidator(cpfSended) {
  ...
  _createClass(CPFValidator, [{
    ...
    value: function geraNovoCpf() {
      var cpfNoDigits = this.cleanCPF.slice(0, -2);
      var digit1 = ValidatesCPF.generatesDigit(cpfNoDigits);
      var digit2 = ValidatesCPF.generatesDigit(cpfNoDigits + digit1);
    ...
    key: "generatesDigit",
    value: function generatesDigit(cpfNoDigits) {
      var total = 0;
